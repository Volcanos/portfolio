export const content = [
    ...
    },
    {
        ...
        description: 'El portal de servicios Tercero de confianza de Aviva Voice se planteó como una manera de vender los servicios que Aviva ya ofrecía a multinacionales, para que pudieran ser utilizados por la pequeña y mediana empresa. Para ello se diseñó y desarrolló una interfaz en ReacJS que se comunicaría con las APIs de sus servicios.',
        listImages: [
            '/images/aviva2.png',
            '/images/aviva3.png',
            '/images/aviva4.png'
    ...
    },
    {
        ...
        web: {url: 'http://www.inoffcomunicacion.com', label: 'inoffcomunicacion.com'},
        mainImage: '/images/inoff1.png',
        title: 'Inoff Comunicación',
        subtitle: 'Web',
        tags: ['Wordpress', 'Javascript', 'ES6'],
        description: 'Para la página web de la agencia de publicidad Inoff Comunicación se desarrolló un theme de Wordpress totalmente personalizado. Se modificó el administrador de Wordpress para que todo el contenido fuera editable.',
        listImages: [
            '/images/inoff2.png',
            '/images/inoff3.png'
        ]
